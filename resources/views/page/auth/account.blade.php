...
@section('title', 'Thông tin tài khoản - Tin tức Du lịch 2023')
@section('style')
@stop
@section('seo')
@stop
@section('content')
    <section class="hero-wrap hero-wrap-2 js-fullheight" style="background-image: url({{ asset('/page/images/bg_6.jpg') }});">
