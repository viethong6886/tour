...
@section('title', 'Thông tin tài khoản - Tin tức Du lịch - Thông tin Du lịch, Tin tức Du Lịch Việt Nam 2023')
@section('style')
@stop
@section('seo')
@stop
                                    ...
                                    <tr>
                                        ...
                                        <td style="vertical-align: middle; width: 50%">
                                         <p><b>Mã booking : </b> {{ $tour->id }}</p>
                                            ...
                                            <p><b>Số phòng đơn @if($tour->fee_singer_room != 0) (có phí  ) @endif :</b> {{ $tour->number_singer_room }} - <b>Thành tiền</b>: {{ number_format($tour->number_singer_room*500000+$tour->fee_singer_room, 0,',','.') }} vnd</p>
                                            <p><b>Số phòng đôi @if($tour->fee_two_room != 0) (có phí  ) @endif :</b> {{ $tour->number_two_room }} - <b>Thành tiền</b>: {{ number_format($tour->number_two_room*800000+$tour->fee_two_room, 0,',','.') }} vnd</p>
                                            <p><b>Số phòng ba @if($tour->fee_three_room != 0) (có phí  ) @endif :</b> {{ $tour->number_three_room }} - <b>Thành tiền</b>: {{ number_format($tour->number_three_room*1000000+$tour->fee_three_room, 0,',','.') }} vnd</p>
                                        ...
                                        <td style="vertical-align: middle; width: 17%">
                                            ...
                                            @if($tour->b_status == 1)
                                                ...
                                                <a class="btn btn-info" target="_blank" href="{{ route('page.prinft_order',$tour->id) }}">Xem dưới dạng PDF</a>
                                            @endif
                                        </td>
                                    </tr>
                                    @php $i++ @endphp
