...
@section('title', 'Du lịch Việt - Trang chủ')
@section('style')
@stop
@section('content')
    <div class="hero-wrap js-fullheight" style="background-image: url({{ asset('page/images/bg_6.jpg') }});">
        <div class="overlay"></div>
        <div class="container">
            <div class="row no-gutters slider-text js-fullheight align-items-center" data-scrollax-parent="true">
                <div class="col-md-7 ftco-animate">
                    {{-- <span class="subheading">Chào mừng bạn đến với Du Lịch Việt</span> --}}
                    <h1 class="mb-4">Khám phá địa điểm yêu thích của bạn</h1>
        ...
        <div class="container">
            <div class="row justify-content-center pb-4">
                <div class="col-md-12 heading-section text-center ftco-animate">
                    <span class="subheading">Đặt Tour</span>
                    <h2 class="mb-4">Danh sách các tour mới nhất</h2>
                </div>
            </div>
            <div class="row">
                @if($tours->count() > 0)
    ...
    <section class="ftco-section services-section">
        <div class="container">
            <div class="row1">
                <div class="col-md-66 order-md-last heading-section pl-md-5 ftco-animate d-flex align-items-center">
                    <div class="w-100">
                        <h1 class="subheading text-center">Xin chào !</h1>
                        <h4 class="mb-4" >Hãy bắt đầu</h4>
                        <h5>Xách balo lên vào đi với chúng tôi, bạn sẽ có được những trãi nghiệm tuyệt vời với dịch vụ của chúng tôi!</h5>
                        <h5>Các bạn hãy tìm đến với Du lịch Việt để được đi đến bất cứ nơi nào trên thế giới. Dành cho người có niềm đam mê bất tận với du lịch!</h5>
                ...
                {{-- <div class="col-md-6 order-md-last heading-section pl-md-5 ftco-animate d-flex align-items-center">
                    <div class="w-100">
                        ...
                        <h2 class="mb-4">Hãy bắt đầu</h2>
                        <p>Xách balo lên vào đi với chúng tôi, bạn sẽ có được những trãi nghiệm tuyệt vời với dịch vụ của chúng tôi!</p>
                        <p>Các bạn hãy tìm đến với Du lịch Việt để được đi đến bất cứ nơi nào trên thế giới. Dành cho người có niềm đam mê bất tận với du lịch!</p>
    ...
    <!-- <section class="ftco-section img ftco-select-destination" style="background-image: url({{ asset('page/images/bg_9.jpg') }});">
        <div class="container">
            <div class="row justify-content-center pb-4">
                <div class="col-md-12 heading-section text-center ftco-animate">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 pl-md-5 py-5">
                                <div class="row justify-content-start pb-3">
                                    ...
                                    <h5>Những chuyến đi du lịch đều đọng lại trong chúng ta nhiều kỉ niệm đặc biệt, vì thế hãy trân trọng những giây phút vui vẻ, hạnh phúc trong chuyến đi của mình. Chúng tôi sẽ đồng hành cùng bạn để góp phần làm cho những trãi nghiệm đó càng thêm tuyệt vời.</h5>                                  
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <section class="ftco-section">
        <div class="container">
            ...
            <div class="row justify-content-center pb-4">
                <div class="col-md-12 heading-section text-center ftco-animate">
                    <span class="subheading">Danh sách</span>
                    <h2 class="mb-4">Ưu đãi sắp tới</h2>
                </div>
            </div>
            <div class="row d-flex">
                @if ($articles->count() > 0)
            ...
            <div class="row justify-content-center">
                <div class="col-md-12 text-center">
                    <div class="img"  style="background-image: url({{ asset('page/images/bg_2.jpg') }});">
                        ...
                        <p class="mb-0"><a href="#" class="btn btn-primary px-4 py-3">Liên hệ với chúng tôi</a></p>
                    </div>
                </div>
            </div>
        </div>
