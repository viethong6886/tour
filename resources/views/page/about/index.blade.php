...
@section('title', 'Giới thiệu - Thông tin Du lịch, Tin tức Du Lịch Việt Nam 2023')
@section('style')
@stop
@section('content')
    <section class="hero-wrap hero-wrap-2 js-fullheight" style="background-image: url({{ asset('/page/images/bg_12.jpg') }});">
            ...
            <div class="row1">
                <div class="col-md-66 order-md-last heading-section pl-md-5 ftco-animate d-flex align-items-center">
                    <div class="w-100">
                        ...
                        <h5>Các bạn hãy tìm đến với Fun Travel để được đi đến bất cứ nơi nào trên thế giới. Dành cho người có niềm đam mê bất tận với du lịch!</h5>
    ...
    <section class="ftco-section ftco-about img"style="background-image: url({{ asset('page/images/bg_11.jpg') }});">
        <div class="overlay"></div>
