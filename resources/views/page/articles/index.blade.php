...
@stop
@section('content')
    <section class="hero-wrap hero-wrap-2 js-fullheight" style="background-image: url({{ asset('/page/images/bg_10.jpg') }});">
        ...
        <div class="container">
            <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-center">
                <div class="col-md-9 ftco-animate pb-5 text-center">
                    ...
                    <h1 class="mb-0 bread">Blog Tin tức</h1>
                </div>
            </div>
        </div>
    </section>
                            ...
                            <div class="row no-gutters">
                                <div class="col-md-9">
                                    <div class="form-group p-4 border-0">
                                        <label for="#">Tìm kiếm ưu đãi cho bạn</label>
